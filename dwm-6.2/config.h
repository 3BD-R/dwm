...
static const char *colors[][3]      = {
     /*               fg         bg         border   */
       ...
       [SchemeSel]  = { col_blue, col_gray0, col_blue },
...
static const Rule rules[] = {
    ...
    { "Chromium-browser", "chromium-browser", NULL, 1 << 3,   0,     -1 },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-i", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray0, "-nf", col_gray3, "-sb", col_blue, "-sf", col_gray4, NULL };
