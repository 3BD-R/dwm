...
static const char *colors[][3]      = {
     /*               fg         bg         border   */
       ...
       [SchemeSel]  = { "#cccccc", col_black/*"#830400"*/, "#0029c8" },
...
static const char *dmenucmd[] = { "dmenu_run", "-i", "-l", "6", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_black, "-sf", col_gray4, NULL };
...
static Key keys[] = {
 ...
 /*	TAGKEYS(                        XK_1,                      0)
    ...
    { 0, XF86XK_MonBrightnessUp,               spawn,                 SHCMD("xbacklight +3") },
    { 0, XF86XK_MonBrightnessDown,             spawn,                 SHCMD("xbacklight -3") },
    ...
    { ControlMask|Mod1Mask|ShiftMask,     XK_Left,    shiftboth,           { .i = -1 } },
 /* { MODKEY|ControlMask,                 XK_h,       shiftswaptags,       { .i = -1 } },
    { MODKEY|ControlMask,                 XK_l,       shiftswaptags,       { .i = +1 } }, */
    { ControlMask|Mod1Mask|ShiftMask,     XK_Right,   shiftboth,           { .i = +1 } },
